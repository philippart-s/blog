...
Vous avez réussi à un truc de fous et toujours dans la bonne humeur en prenant soin de vos spectatrices, spectateurs, oratrices, orateurs et sponsors.  
...
Cette année ils étaient au nombre de 10 en physiques et 3 en virtuels.

Je me dois aussi de parler d'une chose qui fait sa renommée à cette conférence : [les fouées](https://www.my-loire-valley.com/2022/07/fouees-tourangelles/){:target="_blank"}.
Qu'elles soient garnies de rillettes (de Tours bien évidemment), de chèvre (de Touraine bien évidement) ou tout autre chose, c'est délicieux 🤤. 
...
Et chose importante, ne pas s'arrêter à un système qui, souvent, cherche à vous mettre dans des cases ou tout simplement vous exclu de toute forme d'expression.
Non, ce ne sont pas les autres qui doivent décider comment vous aller vous exprimer et partager vos idées mais bien vous en osant faire le premier pas.  
