...
Gitpod vient avec la notion de workspaces, qui représentent en gros une instance de Gitpod sur un repository.
...
J'espère vous avoir donné envie de jeter un oeuil à ce type d'IDE.
