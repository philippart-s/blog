...
A l'époque j'ai donc acheté le modèle [Harmony 700](https://support.myharmony.com/fr-fr/700).

⚠️ Récemment ils ont annoncé qu'ils arrêtaient la commercialisation de ce type d'appareil, c'est bien dommage. ⚠️

## 🙄 C'est bien gentil mais pourquoi parle-t-on de tout ça ?
J'y viens !
...
C'est que l'on s’habitue à n'avoir qu'une seule télécommande à la maison et c'est tellement [WAF](https://en.wikipedia.org/wiki/Wife_acceptance_factor) !

## 🤔 Alors comment faire pour mettre à jour cette télécommande ?
:x: La première chose que j'ai essayé : [Wine](https://www.winehq.org/) : un échec.
...
Le logiciel de synchronisation est écrit en [Sylverligth](https://www.microsoft.com/Silverlight/) ... et comment vous dire, entre les détections aléatoires et les problèmes de plantages je n'étais pas plus avancé ...
...
La partie communication, Concordance,  est écrite en C ([repository](https://github.com/jaymzh/concordance) GitHub), la partie interface en Pyton ([repository](https://github.com/congruity/congruity) GitHub).
...
L'installation de Congruity n'est pas plus compliquée mais demande quelques étapes :
 ...
 - récupérer la dernière version de Congruity sur [sourceforge](https://sourceforge.net/projects/congruity/files/congruity/20/congruity-20.tar.bz2/download) ou cloner le repository. 
...
## ⚙️ Mise à jour de la télécommande
...
🎉 La télécommande est mise à jour !
